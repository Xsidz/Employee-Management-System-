...
const TaskListCount = () => {
  return (
    <div className="flex flex-wrap justify-center gap-4 mt-10 p-4">
      ...
      {/* Pending Task Card */}
      <div className="bg-blue-500 text-white p-6 rounded-xl w-full sm:w-[calc(50%-1rem)] lg:w-[calc(25%-1rem)] shadow-lg flex flex-col items-center text-center">
        <h2 className="text-4xl font-bold mb-2">0</h2>
      ...
      {/* Overdue Task Card */}
      <div className="bg-yellow-500 text-white p-6 rounded-xl w-full sm:w-[calc(50%-1rem)] lg:w-[calc(25%-1rem)] shadow-lg flex flex-col items-center text-center">
        <h2 className="text-4xl font-bold mb-2">0</h2>
